...
class StashedWallet {
  constructor({
    ...
    __privateSet(this, _origin, origin || import_channel.DEFAULT_STASHED_ORIGIN);
  ...
  if (accounts && accounts.length) {
    __privateSet(this, _accounts, accounts.map((account) => {
      return new import_wallet_standard.ReadonlyWalletAccount({
        ...
        publicKey: account.publicKey ? (0, import_utils.fromBase64)(account.publicKey) : new Uint8Array()
      });
    }));
  } else {
    __privateSet(this, _accounts, []);
