...
var _popup, _version, _id, _origin, _name, _chain, _promise, _resolve, _reject, _interval, _listener, _StashedPopup_instances, cleanup_fn, _request;
...
class StashedPopup {
  ...
  send({
    ...
    const requestData = {
      ...
      payload: {
        type,
        chain: __privateGet(this, _chain),
        ...data
      },
    ...
    __privateGet(this, _popup).location.assign(
      `${__privateGet(this, _origin)}/dapp-request${data ? `#${encodedRequestData}` : ""}`
    );
