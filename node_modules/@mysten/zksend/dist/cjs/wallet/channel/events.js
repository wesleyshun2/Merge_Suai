...
const StashedRequestData = (0, import_valibot.variant)("type", [
  ...
  (0, import_valibot.object)({
    type: (0, import_valibot.literal)("sign-transaction-block"),
    data: (0, import_valibot.string)("`data` is required"),
    address: (0, import_valibot.string)("`address` is required")
  }),
  (0, import_valibot.object)({
    type: (0, import_valibot.literal)("sign-personal-message"),
    bytes: (0, import_valibot.string)("`bytes` is required"),
    address: (0, import_valibot.string)("`address` is required")
  })
]);
const StashedRequest = (0, import_valibot.object)({
  id: (0, import_valibot.pipe)((0, import_valibot.string)("`id` is required"), (0, import_valibot.uuid)()),
  origin: (0, import_valibot.pipe)((0, import_valibot.string)(), (0, import_valibot.url)("`origin` must be a valid URL")),
  name: (0, import_valibot.optional)((0, import_valibot.string)()),
